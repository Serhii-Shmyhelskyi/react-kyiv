...
const Dream = () => {
  return (
    <div className={styles.about__preview + " " + styles.sectionLine}>
      ...
      <div className={styles.about__imagesBox + " " + styles.containerContent}>
      ...
      <p className={styles.about__previewText + " " + styles.containerContent}>
        ...
        космічних човників на космодром для їх подальшого запуску. Із-за великих
        розмірів човників, розмістити їх усередині літака небуло можливим.
        Конструктори прийшли до рішення розмістити їх на поверхні повітряного
        судна за допомогою спеціального кріплення. Для цього довелося повністю
        змінити будову хвостової частині літака. Так і з'явився Ан-225.
      </p>
    </div>
  );
};
